...
def calculates_results_stats(results_dic):
    ...
    for arr in results_dic.values():
        matching_labels = arr[2]
        pet_image_is_dog = arr[3]
        classifier_image_is_dog = arr[4]
        ...
        if pet_image_is_dog == 1 and classifier_image_is_dog == 1:
            results_stats_dic['n_correct_dogs'] += 1
        
        if pet_image_is_dog == 0 and classifier_image_is_dog == 0:
            results_stats_dic['n_correct_notdogs'] += 1
            
        if pet_image_is_dog == 1 and matching_labels == 1:
